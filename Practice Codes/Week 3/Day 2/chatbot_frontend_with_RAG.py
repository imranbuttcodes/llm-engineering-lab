...
from chatbot_backend_with_RAG import (
    get_chatbot,
    get_all_conversations,
    save_conversation_name,
    ingest_pdf,               # RAG Imports
    get_uploaded_filenames,   # RAG Imports
)
...
uploaded_file = st.sidebar.file_uploader(
    ...
    "Upload a PDF to this conversation",
...
if uploaded_file is not None:
    ...
    if st.sidebar.button(
        ...
        # ----------------------------------------------
        # Write to a temp file (not a permanent folder)
        # ----------------------------------------------
        ...
        # ----------------------------------------------
        # Ingest, then always clean up the temp file
        # ----------------------------------------------
...
# --------------------------------------------------
# Show docs already uploaded in this thread (NEW)
# --------------------------------------------------

existing_docs = get_uploaded_filenames(
